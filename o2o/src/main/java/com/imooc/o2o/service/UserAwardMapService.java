...
public interface UserAwardMapService {
	 ...
	 */
	UserAwardMapExecution addUserAwardMap(UserAwardMap userAwardMap) throws UserAwardMapOperateException;
	 ...
	 * @throws UserAwardMapOperateException
	 */
	UserAwardMapExecution modifyUserAwardMap(UserAwardMap userAwardMap) throws UserAwardMapOperateException;
}
